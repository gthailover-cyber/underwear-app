...
export const TRANSLATIONS = {
  en: {
    ...
    auctionEarnings: 'Auction Earnings',
    giftEarnings: 'Gift Earnings',
    withdraw: 'Withdraw',
    withdrawDesc: 'Transfer your earnings to your bank account.',
    myRate: 'My Rate',
    myRateTitle: 'My Rate',
  ...
  th: {
    ...
    productEarnings: 'รายได้จากสินค้า',
    auctionEarnings: 'รายได้จากการประมูล',
    giftEarnings: 'รายได้จากของขวัญ',
    withdraw: 'ถอนเงิน',
    withdrawDesc: 'โอนรายได้ของคุณไปยังบัญชีธนาคาร',
    myRate: 'เรทค่าตัว',
