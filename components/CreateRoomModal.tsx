      ...
      <div className="relative w-full max-w-sm bg-gray-900 rounded-3xl border border-gray-800 shadow-2xl overflow-hidden animate-fade-in">
        ...
        <div className="p-6 space-y-6">
           ...
           <div className="flex justify-center">
              <div className="relative w-28 h-28 bg-gray-800 rounded-2xl overflow-hidden border-2 border-dashed border-gray-700 group cursor-pointer hover:border-red-500 transition-colors">
