      ...
      <div className="relative w-full max-w-sm bg-gray-900 rounded-3xl border border-gray-800 shadow-2xl overflow-hidden animate-fade-in flex flex-col">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {DURATIONS.map((dur) => (
                <button
                  ...
                  className={`py-3 rounded-xl font-bold text-sm transition-all border ${selectedDuration === dur.value
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 shadow-lg transition-all ${startingPrice
