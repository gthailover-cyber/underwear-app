          ...
          {streamer.useLiveKit ? (
            <div className="w-full h-full relative overflow-hidden">
              <LiveKitVideo
                ...
                isHost={isHost}
                participantName={isHost ? 'Host' : 'Viewer-' + Math.random().toString(36).substr(2, 9)}
                onError={(error) => {
            ...
            <div className="mb-4 bg-gradient-to-br from-yellow-900/40 to-black/40 backdrop-blur-md rounded-2xl border border-yellow-500/30 p-3 shadow-xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`h-12 px-4 rounded-xl font-bold text-sm shadow-lg transition-all flex flex-col items-center justify-center min-w-[100px] ${bidSuccess
              ...
              <div className="grid grid-cols-3 gap-3 p-4">
                {GIFTS.map(gift => (
                  <button
                    ...
                    className={`relative flex flex-col items-center justify-center p-3 rounded-xl border transition-all active:scale-95 group ${walletBalance >= gift.price
